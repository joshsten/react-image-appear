(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("react-image-appear", [], factory);
	else if(typeof exports === 'object')
		exports["react-image-appear"] = factory();
	else
		root["react-image-appear"] = factory();
})(window, function() {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/ReactImageAppear.js");
/******/ })
/************************************************************************/
/******/ ({
...
(0, _helpers.injectAnimationsScript)();

var ReactImageAppear =
/*#__PURE__*/
function (_Component) {
  _inherits(ReactImageAppear, _Component);

  function ReactImageAppear(props) {
    var _this;

    _classCallCheck(this, ReactImageAppear);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ReactImageAppear).call(this, props));
    _this.state = {
      imgComponent: null
    };
    _this.imageOnLoad = _this.imageOnLoad.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.getImageDimensions = _this.getImageDimensions.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.parseComputedDimensions = _this.parseComputedDimensions.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.createPlaceholder = _this.createPlaceholder.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.getPlaceholderStyle = _this.getPlaceholderStyle.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.createLoader = _this.createLoader.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.getLoaderStyle = _this.getLoaderStyle.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(ReactImageAppear, [{
    ...
    value: function componentDidMount() {
      ...
      this.setState(function (prevState, props) {
        return {
          imgComponent: _react.default.createElement('img', {
            src: src,
            alt: alt,
            onLoad: _this2.imageOnLoad,
            style: {
              opacity: 0
            },
        ...
        _this2.getImageDimensions(imgElement);
      });
    }
  }, {
    key: "imageOnLoad",
      ...
      this.setState(function (prevState, props) {
        return {
          imgComponent: _react.default.createElement('img', {
            ...
            alt: alt,
            style: {
              animation: "".concat(animation, " ").concat(animationDuration, " ").concat(easing)
            }
          })
        };
      });
    ...
    value: function getImageDimensions(imgElement) {
      var _this3 = this;

      var that = this,
          dimensionsInterval = setInterval(function () {
        var _this3$parseComputedD = _this3.parseComputedDimensions(imgElement),
            width = _this3$parseComputedD.width,
            height = _this3$parseComputedD.height;
    ...
    key: "parseComputedDimensions",
    value: function parseComputedDimensions(el) {
      return {
    ...
    value: function createPlaceholder(width, height) {
      var imgComponent = this.state.imgComponent,
      ...
      }, _react.default.cloneElement(imgComponent), this.createLoader());
    ...
    value: function getPlaceholderStyle(width, height) {
      var _this$props3 = this.props,
          placeholderStyle = _this$props3.placeholderStyle,
          placeholder = _this$props3.placeholder;
      var placeholderStyling = Object.assign({}, _constants.PLACEHOLDER_STYLE, placeholderStyle);

      switch (_typeof(placeholder)) {
        case 'boolean':
          if (placeholder) {
            placeholderStyling = Object.assign({}, placeholderStyling, {
              backgroundImage: "url(".concat(_constants.PLACEHOLDER, ")")
            });
          }
      ...
      return Object.assign({}, placeholderStyling, {
        width: width,
        height: height
      });
    }
    ...
    value: function createLoader() {
      var _this$props4 = this.props,
          ...
          loaderClass = _this$props4.loaderClass,
          showLoader = _this$props4.showLoader,
          alt = _this$props4.alt;
      return showLoader ? _react.default.createElement('img', {
        src: loader ? loader : _constants.LOADER,
        alt: alt,
    ...
    key: "getLoaderStyle",
    value: function getLoaderStyle() {
      var loaderStyle = this.props.loaderStyle;
      return Object.assign({}, _constants.LOADER_STYLE, loaderStyle);
    }
  }, {
    key: "render",
...
ReactImageAppear.propTypes = {
  ...
  loaderClass: _propTypes.default.string,
...
ReactImageAppear.defaultProps = {
  loader: _constants.LOADER,
  loaderStyle: {},
  loaderClass: '',
  placeholder: false,
  placeholderStyle: {},
  placeholderClass: '',
  animation: _constants.ANIMATION,
  animationDuration: _constants.ANIMATION_DURATION,
  easing: _constants.EASING,
  showLoader: true,
  alt: ""
};
var _default = ReactImageAppear;
...
exports.PLACEHOLDER_STYLE = PLACEHOLDER_STYLE;
exports.PLACEHOLDER = PLACEHOLDER;
exports.LOADER_STYLE = LOADER_STYLE;
...
exports.injectAnimationsScript = void 0;

var _constants = __webpack_require__(/*! ./constants */ "./src/constants.js");

// Helper functions
var injectAnimationsScript = function injectAnimationsScript() {
  var css = _constants.ANIMATIONS,
...
exports.injectAnimationsScript = injectAnimationsScript;

/***/ })

/******/ });
});
//# sourceMappingURL=react-image-appear.js.map